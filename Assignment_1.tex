...
\textsl{$\dfrac{1}{2}$ \norm {r \times (r_1 + r_2)} = \norm{r_1 \times r_2 \times \cos(\dfrac{\theta}{2})}}
\begin{flushright}
(4)
\end{flushright}
\textsl{}

\textsl{$\therefore$ r = \abs{(\dfrac{2 \times r_1 \times r_2}{r_1+r_2}\times cos(\dfrac{\theta}{2}))}}
\begin{flushright}
(5)
\end{flushright}
\textsl{}

\textsl{Now , D has co-ordinates as \myvec{r\\ \theta}}
